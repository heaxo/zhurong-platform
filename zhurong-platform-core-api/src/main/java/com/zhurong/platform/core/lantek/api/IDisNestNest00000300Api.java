...
* 说明：仅定义接口契约
*/
@RequestMapping("/disNestNest00000300")
public interface IDisNestNest00000300Api {
...
ApiResponse
<PageResponse
<DisNestNest00000300VO>> page(@SpringQueryMap DisNestNest00000300PageQuery pageQuery);
    ...
    */
    @GetMapping("/{id}")
    ApiResponse
    <DisNestNest00000300VO> getById(@PathVariable Long id);
        ...
        */
        @PostMapping
        ApiResponse
        <Long> save(@Valid @RequestBody DisNestNest00000300DTO dto);
            ...
            */
            ...
            <Boolean> update(
                ...
                @Valid @RequestBody DisNestNest00000300DTO dto
                );
