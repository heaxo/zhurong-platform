 ...
 * 说明：仅定义接口契约
 */
public interface ISystCcpp00000100Api {
    ...
    ApiResponse
            <PageResponse
                    <SystCcpp00000100VO>> page(@SpringQueryMap SystCcpp00000100PageQuery pageQuery);
    ...
    @GetMapping("/{id}")
    ApiResponse
            <SystCcpp00000100VO> getById(@PathVariable("id") Long id);
    ...
    @PostMapping
    ApiResponse
            <Long> save(@Valid @RequestBody SystCcpp00000100DTO dto);
    ...
    ApiResponse
            ...
            @Valid @RequestBody SystCcpp00000100DTO dto
    );
