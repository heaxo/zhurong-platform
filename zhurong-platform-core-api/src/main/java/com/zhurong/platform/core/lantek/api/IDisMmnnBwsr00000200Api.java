 ...
 * 说明：仅定义接口契约
 */
public interface IDisMmnnBwsr00000200Api {
    ...
    ApiResponse
            <PageResponse
                        <DisMmnnBwsr00000200VO>> page(@SpringQueryMap DisMmnnBwsr00000200PageQuery pageQuery);
    ...
    @GetMapping("/{id}")
    ApiResponse
            <DisMmnnBwsr00000200VO> getById(@PathVariable("id") Long id);
    ...
    @PostMapping
    ApiResponse
            <Long> save(@Valid @RequestBody DisMmnnBwsr00000200DTO dto);
    ...
    ApiResponse
            ...
            @Valid @RequestBody DisMmnnBwsr00000200DTO dto
    );
