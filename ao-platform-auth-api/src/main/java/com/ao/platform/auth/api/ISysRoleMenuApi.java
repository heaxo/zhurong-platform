...
*/
@GetMapping("/page")
ApiResponse<PageResponse<SysRoleMenuVO>> page(
    ...
    */
    @GetMapping("/{id}")
    ApiResponse<SysRoleMenuVO> getById(@PathVariable Serializable id);

    /**
    * 新增
    */
    @PostMapping
    ApiResponse<Void> save(@Valid @RequestBody SysRoleMenuDTO dto);
