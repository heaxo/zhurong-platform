...
* 说明：仅定义接口契约
*/
@RequestMapping("/api/auth/sysUserRole")
...
*/
@GetMapping("/page")
ApiResponse<PageResponse<SysUserRoleVO>> page(
    ...
    */
    @GetMapping("/{id}")
    ApiResponse<SysUserRoleVO> getById(@PathVariable Serializable id);

    /**
    * 新增
    */
    @PostMapping
    ApiResponse<Void> save(@Valid @RequestBody SysUserRoleDTO dto);
