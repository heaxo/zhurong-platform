...
* 说明：仅定义接口契约
*/
@RequestMapping("/api/auth/sysMenu")
...
*/
@GetMapping("/page")
ApiResponse<PageResponse<SysMenuVO>> page(
    ...
    */
    @GetMapping("/{id}")
    ApiResponse<SysMenuVO> getById(@PathVariable Serializable id);

    /**
    * 新增
    */
    @PostMapping
    ApiResponse<Void> save(@Valid @RequestBody SysMenuDTO dto);
