...
import com.zhurong.platform.core.lantek.api.IWwhhWwhh00000200Api;
...
@RequestMapping("/wwhhWwhh00000200")
public class WwhhWwhh00000200Controller extends BaseController implements IWwhhWwhh00000200Api {

    private final WwhhWwhh00000200Convert convert;
    private final IWwhhWwhh00000200Service service;

    @Override
    public ApiResponse
            <PageResponse
                    <WwhhWwhh00000200VO>> page(WwhhWwhh00000200PageQuery pageQuery) {

        LambdaQueryWrapper<WwhhWwhh00000200> wrapper =
                Wrappers.lambdaQuery(convert.toEntity(pageQuery));

        wrapper.orderByAsc(WwhhWwhh00000200::getRecID);

        Page<WwhhWwhh00000200> page = service.page(
                PageFactory.build(pageQuery),
                wrapper
        );

        List
                <WwhhWwhh00000200VO> voList = page.getRecords()
                .stream()
                .map(convert::toVO)
                .toList();

        PageResponse
                <WwhhWwhh00000200VO> response = new PageResponse<>(
                voList,
                page.getTotal(),
                page.getCurrent(),
                page.getSize()
    ...
    @Override
    public ApiResponse
            <WwhhWwhh00000200VO> getById(Long id) {
        return ApiResponse.success(service.getVOById(id));
    }

    @Override
    public ApiResponse
            <Long> save(@Valid WwhhWwhh00000200DTO dto) {
    ...
    @Override
    public ApiResponse
            <Boolean> update(Long id, @Valid WwhhWwhh00000200DTO dto) {
