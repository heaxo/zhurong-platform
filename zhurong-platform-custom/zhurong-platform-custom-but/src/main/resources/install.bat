...
set "BASE=D:\heaxo\zhurong-platform\zhurong-platform-custom\zhurong-platform-custom-but\build"
set "INPUT=%BASE%\libs"
set "APPIMG_OUT=%BASE%\app-image"
set "OUTPUT=%BASE%\publish"

set "APP_NAME=zhurong-custom-but"
set "APP_VERSION=0.0.4"
set "MAIN_JAR=zhurong-platform-custom-but-%APP_VERSION%.jar"
